    ...
    <div className="bg-slate-400 min-h-screen p-5">
      ...
      <div className="flex flex-row mt-20">
        <div className="basis-1/2 ml-36 mt-2">
          <img src={profile} alt="profile" className="w-[450px] h-[450px] rounded-full shadow-xl" />
        </div>
        <div className="basis-1/2 mr-40">
          ...
          <div className="mt-5 h-12 w-32 bg-blue-900 border border-blue-700 shadow-2xl rounded-lg">
              <a
                href={resume}
                target="_blank"
